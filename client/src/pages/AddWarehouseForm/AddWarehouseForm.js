    ...
    return (
      <div className="main">
        <div className="add-warehouse__header">
          <h2>
            <NavLink to="/warehouses">
              <img className="add-warehouse__back-icon" src={backImg} alt="" />
            </NavLink>{" "}
            Add New Warehouse
          </h2>
        </div>
        <form
          ...
          id="addWarehouse"
          className="add-warehouse__form-container"
          noValidate
        >
        ...
        <div className="add-warehouse__button-container">
          ...
          <button
            type="submit"
            className="add-warehouse__button add-warehouse__button--blue"
            form="addWarehouse"
          >
            + Add Warehouse
          </button>
